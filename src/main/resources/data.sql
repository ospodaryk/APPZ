...
VALUES (DEFAULT, 'Questions about Body Health'),
...
VALUES (DEFAULT, 'What is the best way to maintain a healthy diet?', 1, 1),
...
VALUES (DEFAULT, 1, 1, '2023-01-01T08:00:00', 'Patient in good health, no immediate concerns.', 'Hypertension'),
       (DEFAULT, 2, 2, '2023-01-02T09:00:00', 'Patient reports mild eczema, prescribed topical cream.', 'Eczema'),
       (DEFAULT, 3, 3, '2023-01-03T10:30:00', 'Regular migraine, advised lifestyle changes and medication.',
        'Migraine'),
       ...
       (DEFAULT, 9, 9, '2023-01-09T15:30:00', 'IBS symptoms present, dietary adjustments suggested.',
        'Irritable Bowel Syndrome'),
       (DEFAULT, 10, 10, '2023-01-10T17:00:00', 'Thyroid function normal, continue current medication.',
        'Thyroid Disorder');
...
VALUES (DEFAULT, 1, 1, 1, 11, '2023-12-01'),
...
INSERT INTO public.assigned_poll(id, created_date, deadline, is_completed, doctor_id, poll_id, user_id)
...
INSERT INTO public.poll_questions(poll_id, questions_id)
VALUES (1, 1),
       (1, 2),
       (1, 3),
       (1, 4),
