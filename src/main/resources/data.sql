...
VALUES (DEFAULT, 'volodymyrkolomiy@mail.com', 'Володимир',
        '$2a$10$qiG6YVCCLwVIaLKOGChmru7cf7v1P5Ohrxp3bpyQf56GdvpmKr3U6',
        '380501234567', 'Коломий'),
       (DEFAULT, 'olexlozonevskiy@inbox.com', 'Олександр',
        '$2a$10$qiG6YVCCLwVIaLKOGChmru7cf7v1P5Ohrxp3bpyQf56GdvpmKr3U6',
...
VALUES (1, 'Запитання про самопочуття'),
...
VALUES (1, 'Чи часто у Вас болить голова?', 2, 1),
...
VALUES (DEFAULT, 1, 1, '2023-01-01T08:00:00', 'Пацієнт у хорошому стані здоров’я, негайних проблем немає.', 'Астма'),
       (DEFAULT, 2, 2, '2023-01-02T09:00:00', 'Пацієнт скаржиться на легку екзему, призначено місцевий крем.',
        'Мігрень'),
       (DEFAULT, 3, 3, '2023-01-03T10:30:00', 'Регулярний мігрень, пораджено зміни в способі життя та медикацію.',
        'Діабет'),
       ...
       (DEFAULT, 10, 10, '2023-01-10T17:00:00', 'Функція щитовидної залози нормальна, продовжуйте поточну медикацію.',
        'Дизбактеріоз');


INSERT INTO public.poll (id, poll_title)
VALUES (1, 'Початкове опитування про пацієнта'),
...
values (DEFAULT, '2023-12-01', 19, 1, 5, 1),
